...
namespace XTensions
{
    public static class HelperMethods
    {
        ...
        public static VolumeItemProperties GetProp(IntPtr evidence)
        {
            ...
            if (evidence == IntPtr.Zero) throw new ArgumentException("Zero evidence pointer provided.");
        ...
        public static string GetHashValue(int itemId, HashNumber hashNum = HashNumber.Primary)
        {
            ...
            Hash = System.BitConverter.ToString(ba).Replace("-", "");
        ...
        */
            ...
            UserInputOptions options = UserInputOptions.Unused)
        {
            ...
            {
                int extra = 2048 - suggestedInput.Length;
                char character = '\0';
                suggestedInput += new string (character, extra);
